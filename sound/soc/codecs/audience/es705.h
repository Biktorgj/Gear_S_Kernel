...
#ifdef CONFIG_SND_SOC_ES705_STAND_ALONE_VS_FW
#define SAMSUNG_ES705_FEATURE

#define SEAMLESS_VOICE_WAKEUP
#define FEATURE_STAND_ALONE_VS_FW
#define FEATURE_PDM_MIC_DHWPT
/*
 * Experimental power reduce has temporaily disabled
 *
#define FEATURE_AUDIENCE_POWER_EXP_2ND
*/
#define FEATURE_SENSORY_EXP
#define FEATURE_AUDIENCE_POWER_EXP
#endif
...
struct es705_priv {
	...
	unsigned int stand_alone_vs_fw_enable;
#endif
	int current_bwe;
	int current_veq;
...
#define ES_SET_EVENT_RESP		0x801a0004
#define ES_SELECT_STREAMING		0x90288000
