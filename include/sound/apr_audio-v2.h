...
#define VPM_TX_SM_LVVEFQ_TOPOLOGY	0x1000BFF0
...
struct asm_stream_mtmx_strtr_param_window_v2_t {
        u32    window_lsw;
        u32    window_msw;
};

struct asm_stream_cmd_set_mtmx_strstr_params_v2 {
...
struct asm_mtmx_strtr_params {
        struct apr_hdr  hdr;
        struct asm_stream_cmd_set_mtmx_strstr_params_v2 param;
        struct asm_stream_param_data_v2 data;
	u32 window_lsw;
	u32 window_msw;
} __packed;
