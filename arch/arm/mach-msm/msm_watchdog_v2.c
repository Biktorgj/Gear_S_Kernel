...
static struct tzbsp_dump_buf_s *regsave_vaddr;
static struct tzbsp_dump_buf_s *regsave_paddr;
...
static void configure_bark_dump(struct msm_watchdog_data *wdog_dd)
{
	...
	regsave_vaddr = (struct tzbsp_dump_buf_s *)wdog_dd->scm_regsave;
	regsave_paddr = (struct tzbsp_dump_buf_s *)virt_to_phys(wdog_dd->scm_regsave);
#endif
