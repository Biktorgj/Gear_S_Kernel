...
#define S5K4H5YA_SENSOR_NAME "s5k4h5ya"
#define s5k4h5ya_obj s5k4h5ya_##obj
#include <linux/gpio.h>
#include <mach/gpiomux.h>

#define S5K4H5YA_DEBUG
#undef CDBG
#ifdef S5K4H5YA_DEBUG
#define CDBG(fmt, args...) printk("s5k4h5ya: %s:%d : "fmt,   __FUNCTION__, __LINE__, ##args)
#else
...
static struct msm_sensor_power_setting s5k4h5ya_power_setting[] = {
	{	//	CAM1_RST_N
...
static struct msm_sensor_power_setting s5k4h5ya_power_off_setting[] = {
	{
		.seq_type = SENSOR_VREG,
		.seq_val = CAM_VDIG,
		.config_val = 0,
...
static int32_t msm_s5k4h5ya_i2c_probe(struct i2c_client *client,
	const struct i2c_device_id *id)
{
	return msm_sensor_i2c_probe(client, id, &s5k4h5ya_s_ctrl);
}
static const struct i2c_device_id s5k4h5ya_i2c_id[] = {
	{S5K4H5YA_SENSOR_NAME, (kernel_ulong_t)&s5k4h5ya_s_ctrl},
	{ }
};

static struct i2c_driver s5k4h5ya_i2c_driver = {
	.id_table = s5k4h5ya_i2c_id,
	.probe  = msm_s5k4h5ya_i2c_probe,
	.driver = {
		.name = S5K4H5YA_SENSOR_NAME,
	},
};
...
static int __init s5k4h5ya_init_module(void)
{
	int32_t rc = 0;
	CDBG("E\n");
...
static struct msm_sensor_ctrl_t s5k4h5ya_s_ctrl = {
	...
	.power_setting_array.power_setting = s5k4h5ya_power_setting,
	.power_setting_array.size = ARRAY_SIZE(s5k4h5ya_power_setting),
	.power_setting_array.power_off_setting = s5k4h5ya_power_off_setting,
	.power_setting_array.off_size = ARRAY_SIZE(s5k4h5ya_power_off_setting),
...
module_init(s5k4h5ya_init_module);
module_exit(s5k4h5ya_exit_module);
MODULE_DESCRIPTION("s5k4h5ya");
