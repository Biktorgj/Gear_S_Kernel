	...
	struct device_attribute *attr, char *buf)
{
	...
	raw_x = (uint16_t)((dcm_Matrix[0][0]*tilt_x + dcm_Matrix[0][1]*tilt_y +
		dcm_Matrix[0][2]*tilt_z) / 100000);
	raw_y = (uint16_t)((dcm_Matrix[1][0]*tilt_x + dcm_Matrix[1][1]*tilt_y +
		dcm_Matrix[1][2]*tilt_z) / 100000);
	raw_z = (uint16_t)((dcm_Matrix[2][0]*tilt_x + dcm_Matrix[2][1]*tilt_y +
