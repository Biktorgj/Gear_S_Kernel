...
/*
 * dbs_input_handler is disabled as the refresh callback updates policy
 * frequency (policy->cur) incorrectly, if CPU_FREQ_PM_QOS is applied
 */
#undef DBS_INPUT_HANDLER_ENABLED
...
#ifdef DBS_INPUT_HANDLER_ENABLED
