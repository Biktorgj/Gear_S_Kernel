...
extern bool g_bAmpEnabled;
static bool is_ioctl_enable=false;
...
#endif
{
    switch (cmd)
    {
		...
		is_ioctl_enable = true;
		ImmVibeSPI_ForceOut_AmpEnable(arg);
		pr_info("tspdrv : ioctl_en=%d, inponte_en=%d\n",is_ioctl_enable, g_bAmpEnabled);
#ifdef CONFIG_TSPDRV_HISTORY
				{
					struct timespec ts;
